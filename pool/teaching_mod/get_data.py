...
def get_ardData(ard_data, ard_flg):
  ser2ard = serial.Serial('/dev/ttyACM0', 9600)
  while True:
    try:
      ...
      ard_data['lipoC3S1'] = data['lipoC2']
      ard_data['lipoC3S2'] = data['lipoC2']
...
def sort_data(axis_data, ard_data):
  log_data = {
    ...
    'axis_pressure' : 0#,
    #'depth' : int(float(ard_data['depth']) * 10000),
  }
...
if __name__ == "__main__":
  ard_data_test = {"test" : 0.0}
  ard_flg_test = multiprocessing.Value('b',True)
  get_ardData(ard_data_test,ard_flg_test)