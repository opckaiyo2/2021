...
def Teaching(sen_data):
    ...
    of.rotate_advance(rotate[0],ini_x)
    # 潜水位置まで-------------------------------------------------
    ...
    of.diving_advance(rotate[1],ini_x)
    # 潜航　途中浮上位置まで--------------------------------------
    ...
    print("浮上位置まで")
    # モータの回転数で機体を前進させる関数(潜りながら)潜る深さはコンフィグファイル
    of.diving_advance(rotate[2],ini_x)
    # 浮上位置まで------------------------------------------------
    ...
    print("浮上位置まで")
    # モータの回転数で機体を前進させる関数(潜りながら)潜る深さはコンフィグファイル
    of.diving_advance(rotate[3],ini_opx)
    # 浮上位置まで------------------------------------------------
    ...
    print("スタート位置まで")
    # モータの回転数で機体を前進させる関数(潜らない)
    of.rotate_advance(rotate[4],ini_opx)
    print("\n")
    # スタート位置まで--------------------------------------------
